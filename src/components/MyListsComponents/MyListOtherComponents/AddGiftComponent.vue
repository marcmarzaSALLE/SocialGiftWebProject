...
<template>
  <div class="add-gift-div" >
    <a class="add-gift-button" href="#gifts-products-screen" @click="getAllProducts">+ add gift</a>
    ...
    <div id="gifts-products-screen" class="gifts-products-div">
      <div class="gift-products-main-div">
        ...
        <div class="search-gift-div">
          ...
          <input class="search-gift-input" type="text" v-model="searchInput" placeholder="Look for a gift..."/>
          <!--Botón de búsqueda-->
